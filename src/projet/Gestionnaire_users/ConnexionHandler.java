...
/*
 * Classe servant à traiter les requêtes du portail afin de se connecter ou de s'inscrire
 */

public class ConnexionHandler implements HttpHandler
{
	public void handle(HttpExchange t) 
	  {
	        JSONObject reponse = new JSONObject();
        	reponse.put("message", "login");
	        ...
	        if(query != null)
	        {
	        	...
	        	if(g.verifUser(json.getString("login"), json.getString("mdp")))
	        	{
	        		...
	        		System.out.println("Connexion de l'utilisateur réussie");
	        	}
	        	else
	        	{
